...
class Solution2Test {
    ...
    @Test
    @DisplayName( "버블 정렬 테스트 케이스 1" )
    void test_case_1 () throws Exception {
        String solution = getSolution( "static/section6/solution2/test_case1.txt" );
    ...
    @Test
    @DisplayName( "버블 정렬 테스트 케이스 2" )
    void test_case_2 () throws Exception {
        // given
        String solution = getSolution( "static/section6/solution2/test_case2.txt" );
    ...
    @Test
    @DisplayName( "버블 정렬 테스트 케이스 3" )
    void test_case_3 () throws Exception {
        // given
        String solution = getSolution( "static/section6/solution2/test_case3.txt" );
    ...
    @Test
    @DisplayName( "버블 정렬 테스트 케이스 4" )
    void test_case_4 () throws Exception {
        // given
        String solution = getSolution( "static/section6/solution2/test_case4.txt" );
    ...
    @Test
    @DisplayName( "버블 정렬 테스트 케이스 5" )
    void test_case_5 () throws Exception {
        // given
        String solution = getSolution( "static/section6/solution2/test_case5.txt" );
