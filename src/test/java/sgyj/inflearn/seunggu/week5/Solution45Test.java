...
class Solution45Test {
    ...
    void test_case_1 () throws Exception {
        String solution = getSolution( "static/solution45/test_case1.txt" );
    ...
    private String getSolution ( String fileName ) throws IOException {
        ...
        // when
        return Solution45.solution( reader );
    }
    ...
    void test_case_2 () throws Exception {
        // given
        String solution = getSolution( "static/solution45/test_case2.txt" );
    ...
    void test_case_3 () throws Exception {
        // given
        String solution = getSolution( "static/solution45/test_case3.txt" );
    ...
    void test_case_4 () throws Exception {
        // given
        String solution = getSolution( "static/solution45/test_case4.txt" );
    ...
    void test_case_5 () throws Exception {
        // given
        String solution = getSolution( "static/solution45/test_case5.txt" );
